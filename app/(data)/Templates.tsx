export default [
  {
    name: "Blog Title",
    desc: "An AI tool that generates the title of the blog depenging on your blog information.",
    category: "Blog",
  ...
  {
    name: "Explain Code",
    desc: "An AI Model that explains the programming code given to it in any language.",
