...
const Billing = () => {
  ...
  const OnPayment = (subId: string) => {
    const options = {
      ...
      "name":'Saas AI Content Generator',
      ...
      <div className="flex justify-center space-x-8 ">
        <div className="bg-white rounded-lg shadow-lg p-8 w-80 flex flex-col items-center">
          ...
          <ul className="text-left mb-4">
            <li className="mb-2"><span className="text-blue-500">✓</span> 10,000 Words/Month</li>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 w-80 flex flex-col justify-center items-center">
          ...
          <ul className="text-left mb-4">
            <li className="mb-2"><span className="text-blue-500">✓</span> 1,00,000 Words/Month</li>
